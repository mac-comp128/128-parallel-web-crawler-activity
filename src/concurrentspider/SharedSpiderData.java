...
public class SharedSpiderData {
	 ...
	 */
	private ConcurrentAllUrlsCounter urlCounter = new ConcurrentAllUrlsCounter();
	 ...
	 * @return the ConcurrentAllUrlsCounter object where we keep counts of URLs
	 */
	public ConcurrentAllUrlsCounter getUrlCounter() {
		return urlCounter;
	}
